...
urlpatterns = [
    ...
    path("api/", include("ai_query.urls")),
    ...
    path('client/', views.client, name='client'),  # Also accessible at /dashboard/
    path('bonus/', views.bonus, name='bonus'),  # Also accessible at /dashboard/
    path('competitive/', views.competitive, name='competitive'),  # Also accessible at /dashboard/
    path('another/', views.plan_workflow, name='another'),
    path('employees/', views.employee_analytics, name='employee_analytics'),
    path('admin-main/', views.admin_main_only_me, name='admin_main_only_me'),
